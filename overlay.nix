...
in {
  vit-servicing-station = final.runCommand "vit-servicing-station-static" {
    src = final.fetchurl {
      url = "https://github.com/mzabaluev/vit-servicing-station/releases/download/v0.1.0-ci-test.1/vit-servicing-station-0.1.0-ci-test.1-x86_64-unknown-linux-musl.tar.gz";
