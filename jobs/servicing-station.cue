...
#ServicingStation: types.#stanza.job & {
	...
	group: "servicing-station": {
		...
		service: "\(namespace)-servicing-station": {
			...
			#paths: "/api/{x:(vit-version|v0/(block0|fund|proposals|reviews|challenges).*)}"
			...
			tags: [
				...
				"traefik.http.middlewares.\(namespace)-vss-cors-headers.headers.accesscontrolallowheaders=*",
