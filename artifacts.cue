...
artifacts: {
	"catalyst-perf": {
		block0: {
			...
			checksum: "sha256:ffedaf7757f5796202b02a8966b4028873f32452dbf50572f10ebeefbcfd9359"
		}
		database: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-perf/database.sqlite3"
			checksum: "sha256:fd6d40bfc1ac979aab4a04302f882dbdad229c546ce4d20aefa7067d4118a452"
		}
	}
	"catalyst-dryrun": {
		block0: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-dryrun/block0.bin"
			checksum: "sha256:6cd84b60660b9035a636c39336a77c76a8ed2abe0f896d8dbd43f68f3f91293f"
		}
		database: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-dryrun/database.sqlite3"
			checksum: "sha256:8d42c1c54c2808a02d73db59d65de979061ac09d116587dcc5677d79e120523b"
		}
	}
	"catalyst-fund3": {
		block0: {
	...
	"catalyst-signoff": {
		block0: {
			...
			checksum: "sha256:7e32914c10c5e520db55a11fcae5a647e60e3dfcd6841b6d41cf8046b83d999a"
		}
		database: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-signoff/database.sqlite3"
			checksum: "sha256:e73a84eb2a231938def689d56be688ae8207e8853da2237844ad446accbf263f"
		}
	}
	"catalyst-test": {
		block0: {
