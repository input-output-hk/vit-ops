...
artifacts: {
	"catalyst-perf": {
		block0: {
			...
			checksum: "sha256:358218efacd5040b9e4ae14c1ae8873d8d777520a7522d8e3405c4266546bd26"
		}
		database: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-perf/database.sqlite3"
			checksum: "sha256:cdbede84c3ba559349c1cc8033efc29b2235e19363439bdd90cf82b3544c4b7c"
		}
	}
	"catalyst-dryrun": {
		block0: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-dryrun/block0.bin"
			checksum: "sha256:e030ebf9ded07d3dedbf016e6774bebf2f2e96ed930ba20dc8c3778c16117a14"
		}
		database: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-dryrun/database.sqlite3"
			checksum: "sha256:2691911452eea8f77a5afc3e1215ef1bb41d4928729a27de5e53ac106f747d8d"
		}
	}
	"catalyst-fund3": {
		block0: {
	...
	"catalyst-signoff": {
		block0: {
			...
			checksum: "sha256:96513d534cef7f1ff6bf1fb19d271d35c7d80cc7464c8867bcd76b0f981bdee3"
		}
		database: {
			url:      "s3::https://s3-eu-central-1.amazonaws.com/iohk-vit-artifacts/catalyst-signoff/database.sqlite3"
			checksum: "sha256:8f3ee3ae95856364216997c1e4e075eddb408bdca5730adad89e55832ce52de0"
		}
	}
	"catalyst-test": {
		block0: {
